...
bool utils_WriteFileW(const wchar_t* path, void* inBuffer, unsigned long bufferSize, bool binaryFile = false, bool append = false);
bool utils_ReadFileW(const wchar_t* path, void* outBuffer, unsigned long bufferSize, bool binaryFile = false);
