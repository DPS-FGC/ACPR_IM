...
SteamApiHelper::SteamApiHelper(ISteamUserStats* pSteamUserStats)
	: m_pSteamUserStats(pSteamUserStats)
{
	LOG(2, "SteamApiHelper::SteamApiHelper, *pSteamUserStats: 0x%p\n", *pSteamUserStats);
